...
// Два независимых продукта. У каждого — свои ключи и релизы.
export const SOFTWARE = [
  { id: 'infinity', name: 'Infinity 1.21.4 (Fabric)', version: '1.21.4', loader: 'fabric' },
  { id: 'lobok', name: 'Lobok Client 1.16.5', version: '1.16.5', loader: 'fabric' },
];
export function validSoftware(v) { return SOFTWARE.some(s => s.id === v); }
